...
cprequire_test(["inline:com-chilipeppr-workspace-marcob"], function(ws) {
    ...
    $('title').html("marcob Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-marcob", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-marcob", // Make the id the same as the cpdefine id
        name: "Workspace / marcob", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace marcob.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a marcob
