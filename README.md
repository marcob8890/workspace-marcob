# com-chilipeppr-workspace-marcob
A ChiliPeppr Workspace marcob.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / marcob
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-marcob |
| Name                  | Workspace / marcob |
| Description           | A ChiliPeppr Workspace marcob. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/marcob8890/workspace-marcob/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/marcob8890/testtinyg |
| Github URL            | http://github.com/marcob8890/workspace-marcob |
| Test URL              | https://preview.c9users.io/marcob8890/testtinyg/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/marcob8890/workspace-marcob/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-marcob"], // the id you gave your workspace
      function(myWorkspaceMarcob) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / marcob just got loaded.", myWorkspaceMarcob);
        myWorkspaceMarcob.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-marcob"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / marcob"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace marcob."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/marcob8890/workspace-marcob/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/marcob8890/testtinyg"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/marcob8890/workspace-marcob"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://testtinyg-marcob8890.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
